								...
								<div class="panel-body">
									<form action="/detailtransaksi/{{$detailtransaksi->id}}/update" method="POST">
									  ...
									  <div class="form-group">
									    ...
									    <input name="point" type="integer" class="form-control" id="no_tlp" aria-describedby="emailHelp" value="{{$detailtransaksi->point}}">
									  </div>
									  <div class="form-group">
...
@section('content')
		...
		<div class="row">
			...
			<form action="/detailtransaksi/{{$detailtransaksi->id}}/update" method="POST">
			  ...
			  <div class="form-group">
			    <label for="exampleInputEmail1">Point</label>
			    <input name="point" type="integer" class="form-control" id="point" aria-describedby="emailHelp" value="{{$detailtransaksi->point}}">
			  </div>
			<div class="modal-footer">
		 		<button type="submit" class="btn btn-warning">Update</button>
		 		</form>
